...
# Asset names: 
# "WTI", "Brent", "Gasoline_NYH", "Gasoline_US_Gulf", "NYHNo2HeatingOil", "LA_Diesel",
# "USGulf_Kerosine", "Propane", "HenryHubNG"
...
# asset index
j = which(attr(data, 'dimnames')[[2]] == asset)
...
name.df = paste(model, asset, freq, sep='__')
